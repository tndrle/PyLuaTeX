...
% default for localimports is true
\begin{python}
import sys
import os
...
print('x')
\end{pythonq}
\pyif{a == 7}{\begin{center} a \end{center}}{a \par b}
\pyif{a == 8}{\begin{center} a \end{center}}{a \par b}
\pyif{a == 1}{$a = 1$}{$a \neq 1$}
\directlua{
    if not (pyluatex.get_last_code()[1] == "a = 7") then tex.error("test failed") end
    if not (pyluatex.get_last_output()[1] == "x") then tex.error("test failed") end
}
